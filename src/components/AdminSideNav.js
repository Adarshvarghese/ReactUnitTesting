    ...
    <Box sx={{ display: 'flex', marginTop:30 }} >
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <ListItem  disablePadding sx={{ display: 'block' }}  >
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{updateAction('viewAccount')}} >
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{updateAction('Search')}}  >
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              >
                ...
                <ListItemText primary='Search Users' sx={{ opacity: open ? 1 : 0 }}  />
